...
export default function QuyenPage() {
  ...
  const systemMenus = [
    ...
    { key: 'doiSoat', name: 'Đối soát doanh thu', path: '/doi-soat', desc: 'So sánh doanh thu khai báo với tiền THU thực nhận về quỹ, phát hiện tháng bất thường theo trung vị' },
